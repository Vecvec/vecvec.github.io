...
![image](/_posts/assets/Frame_27_mcmc.png)
...
<details>
  ...
  ![image](/_posts/assets/Frame_1_restir.png)
...
![image](/_posts/assets/Frame_0_mcmc_world.png) < first frame (just world space Markov chains)

![image](/_posts/assets/Frame_1_mcmc_world.png) < second frame (just world space Markov chains)

![image](/_posts/assets/Frame_57_mcmc_world.png) < 58th frame (just world space Markov chains)
...
![image](/_posts/assets/Frame_1_mcmc_screen.png) < second frame (just screen space Markov chains)

![image](/_posts/assets/Frame_42_mcmc_screen.png) < 43rd frame (just screen space Markov chains) (Note that the light reflecting of the box is hard to see)

![image](/_posts/assets/Frame_42_mcmc_screen_div_5.png) < 43rd frame everything divided by 5 to show fireflies.
...
![image](/_posts/assets/Frame_42_mcmc_screen_norm.png) < 43rd frame, everything divided by ~133 to show fireflies.
